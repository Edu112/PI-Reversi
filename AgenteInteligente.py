...
class AgenteInteligente(Jogador): # Herda de Jogador
    ...
    def heuristica(self, invertible_pieces_per_direction):
        ...
        qtd_invertible_pieces_per_direction = [len(invertible_pieces_per_direction[0]), len(invertible_pieces_per_direction[1]), len(invertible_pieces_per_direction[2]), len(invertible_pieces_per_direction[3]), len(invertible_pieces_per_direction[4]), len(invertible_pieces_per_direction[5]), len(invertible_pieces_per_direction[6]), len(invertible_pieces_per_direction[7])]
        ...
        if self.qtd_invertible_pieces < greater_quantity:
            ...
            if qtd_invertible_pieces_per_direction.index(greater_quantity) == 0: # direction = "up"
                ...
                self.index_to_play = invertible_pieces_per_direction[0][less_index]
                ...
                self.index_to_play = invertible_pieces_per_direction[1][less_index]
                ...
                self.index_to_play = invertible_pieces_per_direction[2][less_index]
                ...
                self.index_to_play = invertible_pieces_per_direction[3][less_index]
                ...
                self.index_to_play = invertible_pieces_per_direction[4][less_index]
                ...
                self.index_to_play = invertible_pieces_per_direction[5][less_index]
                ...
                self.index_to_play = invertible_pieces_per_direction[6][less_index]

            else: # direction = "diagonal right down"
                less_index = len(invertible_pieces_per_direction[7]) - 1
                self.index_to_play = invertible_pieces_per_direction[7][less_index]
